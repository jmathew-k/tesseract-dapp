...
const messages = [
  {
    ...
    time: "11:59AM",
    content:
      'When do you release the coded for the Fleet - Travel kit? <a href="https://tesseractxyz.com" target="_blank" rel="noopener noreferrer">https://tesseractxyz.com</a>',
  },
  {
    id: 1,
    man: "Britney Beer",
    ...
    time: "11:59AM",
    content:
      'Hi @orval, thanks for contacting.<br>Yes, I’m working on it. It would be released next 2 weeks. You could check the progress here: <a href="https://tesseractxyz.com" target="_blank" rel="noopener noreferrer">https://ui8.net/progress</a><br></br>Thanks for your patience and understanding. <span role="img" aria-label="pray">🙌</span><br> Regards,<br></br>Br',
  },
];
