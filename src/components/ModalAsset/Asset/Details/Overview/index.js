    ...
    <>
      <div className={styles.overview}>
        ...
        <div className={styles.info}>
          Elegant asset mockup for your next project
        </div>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.content}>
              <p>
                ...
                next crypto, NFT asset faster.
              </p>
              <p>
                Types of screens included: onboarding, connect wallet, home
                feed, profile, upload, menu, search, asset detail,
                notification...
              </p>
              <p>
      ...
      <ModalPreview
        ...
        figcaption="Elegant asset mockup for your next project"
        download
      />
    </>
  );
